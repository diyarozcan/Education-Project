    ...
    public class ProductSeed : IEntityTypeConfiguration<Product>
    {
        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 2, Name = "Tükenmez Kalem", Price = 25.50m, Stock = 200, CategoryId = _ids[0] },
                ...
                new Product { Id = 6, Name = "Resim Defter", Price = 65.25m, Stock = 100, CategoryId = _ids[1] }
                );
        }
    }
}
